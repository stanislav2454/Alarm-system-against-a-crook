...
//    public float machinegunSpreadAngle = 2f;
//    public float pistolRecoilForce = 0.1f;

//    [Header("Decorator Base Multipliers")]
//    public float scopeDamageMultiplier = 1.2f;
//    public float scopeFireRateMultiplier = 0.9f; // замедление при прицеливании
//    public float scopeZoomAmount = 30f;
//    public float scopeZoomSpeed = 10f;

//    public float extendedMagAmmoMultiplier = 1.5f;
//    public float extendedMagReloadMultiplier = 1.2f; // дольше перезарядка

//    public float silencerDamageMultiplier = 0.8f; // меньше урона
//    public float silencerFireRateMultiplier = 1f; // без изменений
//    public float silencerNoiseReduction = 0.3f; // 70% тише
...
//    // Метод для получения базового времени между выстрелами
//    public float GetBaseAttackInterval()
//    {
//        return 1f / (baseFireRate * globalFireRateMultiplier);
//    }

//    // Метод для получения базового урона
